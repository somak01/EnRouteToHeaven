...
#		that has all the characters of the input file in uppercase


#Processing:	1) Open the input file
#		2) Open the output file
#		4) While we're not at the end of the input file
#			a) read part of a file into the memory buffer
#			b) go through each by of memory 
...
#This will be discussed in "Conting Like  COmputer"
.equ O_RDONLY, 0
...
.equ ST_FD_IN, -4
.equ ST_FD_OUT, -8
.equ ST_FD_ARGC, 0 #Number of arguments
...
#Purpose: This function actually does the heavy lifting
#	  it does the uppercase conversion
#
